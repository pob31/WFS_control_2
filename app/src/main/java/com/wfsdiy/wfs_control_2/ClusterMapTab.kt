    ...
    BoxWithConstraints(modifier = Modifier.fillMaxSize()) {
        ...
        Canvas(modifier = Modifier
            ...
            clusterMarkers.sortedByDescending { it.id }.forEach { clusterMarker ->
                drawMarker(clusterMarker, draggingMarkers.containsValue(clusterMarker.id), textPaint, true, stageWidth, stageDepth, stageOriginX, stageOriginY, canvasWidth, canvasHeight, !isPhone)
            }
        }
    }
}
